...
_LAZY_MAP: dict[str, tuple[str, str]] = {
    ...
    "LegalClause":         ("antcrew.core.artifacts", "LegalClause"),
    "LegalFindingArtifact":("antcrew.core.artifacts", "LegalFindingArtifact"),
    "MigrationIssue":      ("antcrew.core.artifacts", "MigrationIssue"),
    "MigrationPlanArtifact":("antcrew.core.artifacts","MigrationPlanArtifact"),
    "RiskLevel":           ("antcrew.core.artifacts", "RiskLevel"),
    ...
    "WebhookSink":         ("antcrew.core.events",           "WebhookSink"),
    ...
    "CodeMigrationTeam":   ("antcrew.teams.migration_team",        "CodeMigrationTeam"),
    "ContentTeam":         ("antcrew.teams.content_team",          "ContentTeam"),
    "DevTeam":             ("antcrew.teams.dev_team",              "DevTeam"),
    "LegalReviewTeam":     ("antcrew.teams.legal_team",            "LegalReviewTeam"),
    ...
    # Tier 3 teams
    "BrandVoiceContentTeam": ("antcrew.teams.brand_voice_team",   "BrandVoiceContentTeam"),
    "BrandVoiceProfile":     ("antcrew.teams.brand_voice_team",   "BrandVoiceProfile"),
    "ReproducibleResearchPipeline": ("antcrew.teams.reproducible_research", "ReproducibleResearchPipeline"),
    "ExperimentRecord":      ("antcrew.teams.reproducible_research", "ExperimentRecord"),
    # Agency / white-label
    "BillingRecord":         ("antcrew.agency",                   "BillingRecord"),
    "WhiteLabelWrapper":     ("antcrew.agency",                   "WhiteLabelWrapper"),
    # Misc packages
